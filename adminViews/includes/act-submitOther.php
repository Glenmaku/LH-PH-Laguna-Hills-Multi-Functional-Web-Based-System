...
<script>
  ...
  function other_add_data() {
    ...
    if ($("#o_category").val() && $("#o_quantity").val() && $("#o_price").val() && $("#o_subtotal").val()) {
      data.services.push({
    ...
    if ($("#o_category1").val() && $("#o_quantity1").val() && $("#o_price1").val() && $("#o_subtotal1").val()) {
      data.services.push({
    ...
    if ($("#o_category2").val() && $("#o_quantity2").val() && $("#o_price2").val() && $("#o_subtotal2").val()) {
      data.services.push({
    ...
    if ($("#o_category3").val() && $("#o_quantity3").val() && $("#o_price3").val() && $("#o_subtotal3").val()) {
      data.services.push({
    ...
    if ($("#o_category4").val() && $("#o_quantity4").val() && $("#o_price4").val() && $("#o_subtotal4").val()) {
      data.services.push({
