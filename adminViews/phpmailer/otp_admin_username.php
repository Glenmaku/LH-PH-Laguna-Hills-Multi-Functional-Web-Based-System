...
function Ad_username($adacquired_email, $gen_code){
...
try {
    ...
    $mail->Port = 587;     
    $mail->isHTML(true); //Recipients
    $mail->setFrom('emailAddress@gmail.com', 'OTP LHPH Emailer');

    $mail->addAddress($adacquired_email,);     //Add a recipient
    ...
    $mail->Body = "Your OTP code is $gen_code";
