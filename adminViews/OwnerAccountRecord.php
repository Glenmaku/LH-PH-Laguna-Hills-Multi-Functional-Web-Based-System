                ...
                <div class="modal-body">
                    ...
                    <form><!--container-->
                        ...
                        <div class=" input-group  mb-3"><!--FOR OWNER lot_id FIELD-->
                            ...
                            <input list="blkandlotss" name="property" id="property" class="form-control property" placeholder="Select Property..." />
                            <datalist id="blkandlotss"></datalist>
                        </div>
<script>
    $.ajax({
  type: "POST",
  url: "adminViews/includes/fetch_property_forassign.php",
  success: function(data) {
    var lots = JSON.parse(data);
    $.each(lots, function(index, lot) {
      $("#blkandlotss").append("<option value='" + lot.lot_id + "'>");
    });
  }
});
</script>
