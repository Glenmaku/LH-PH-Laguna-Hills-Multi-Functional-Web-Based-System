      ...
      <div class="row justify-content-around text-center text-md-start">
        ...
        <div class="col-md-2 ">
          <ul class="list-unstyled">
            ...
            <li class="fortext">
            <a href="#home" onclick="activateNav('navhome'); Homenav();">Home</a>
            </li>
            <li class="fortext">
            <a href="#AboutUs"  onclick="activateNav('navaboutus');AboutUsnav();">About Us</a>
            </li>
            <li class="fortext">
            <a href="#Amenities"  onclick="activateNav('navamenities');Amenitiesnav();">Amenities</a>
            </li>
            <li class="fortext">
            <a href="#PropertyFinder" id="property-finder-page" onclick="activateNav('property-finder-page');PropertyFindernav();">Property Finder</a>
            </li>
            <li class="fortext">
              <a href="#ContactUs"  onclick="activateNav('navcontactus');ContactUsnav();">Contact Us</a>
            </li>
          </ul>
