...
<body>
                ...
                ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td> <button data-bs-toggle="modal" data-bs-target="#deleteOwnerModal" id="btn_delete_owner_acc" class="btn_delete_owner_acc" name="delete_button">DELETE</button> </td><!--TRASHICON-->
                                </tr>
                            </tbody>
                        <?php
                        }
    ...
    <script>
        ...
        function get_owner_record(updateownerid) { // to show the current data
            ...
            $.post("includes/Act-UpdateOwner.php", {
        ...
        function get_owner_info(viewid) { // to show the current data
            ...
            $.post("includes/Act-ViewOwner.php", {
                viewid: viewid
            }, function(data, status) {
        ...
        function display_assignedlot_table_record() {
            ...
            $(document).on('click', '#btn_qq', function() {
                ...
                $.ajax({
                    url: 'includes/Act-display-assignedlot-records.php',
                    type: 'post',
                    data: {
